# ShellSense
AI-powered natural language shell assistant that converts plain English into explainable, risk-aware Linux commands with safety checks and controlled execution.
